...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.STATUS_REACT === "true"){
 ...
 //============================================================================ 
    if(body === "send" || body === "Send" || body === "sendme" || body === "Sendme" || body === "bhjo" || body === "Bhjo" || body === "Sendplease" || body === "sendplease" || body === "save" || body === "Save" || body === "snd" || body === "Snd" || body === "status" || body === "Status" || body === "sv" || body === "Sv" || body === "plzsend" || body === "Plzsend" || body === ".send" || body === ".Send" || body === ".save" || body === ".Save"){
